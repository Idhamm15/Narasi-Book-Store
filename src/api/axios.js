...
export const getUsersList = () => {
  return (dispatch) => {
    axios
      .get("https://kawahedukasibackend.herokuapp.com/")
...
export const postUserCreate = (data) => {
  return (dispatch) => {
    axios
      .post(
         "https://kawahedukasibackend.herokuapp.com/content/create",
        data
      )
      .then(function (response) {
...
export const deleteUser = (id) => {
  return (dispatch) => {
    axios
      .delete(
         "https://kawahedukasibackend.herokuapp.com/content/delete"+id,
      )
      .then(function (response) {
        console.log(response);
